...
namespace Web.Admin
{
    public partial class Template : WMS_UI
    {
        ...
        {
            e.Total = int.Parse(WMSFactory.{TABLENAME}.GetTotalCount(e.Parameters[{TABLENAME}_Filter.ParamPrefix], conditions));
            IList<{TABLENAME}> list = WMSFactory.{TABLENAME}.FindAllByPage(e.Start, e.Limit, 11, e.Parameters[{TABLENAME}_Filter.ParamPrefix], conditions);
        ...
        protected void BtnDel_Click(object sender, DirectEventArgs e)
        {
            ...
            foreach (SelectedRow row in sm.SelectedRows)
            {
                ...
                _{TABLENAME}.nid = int.Parse(row.RecordID);
